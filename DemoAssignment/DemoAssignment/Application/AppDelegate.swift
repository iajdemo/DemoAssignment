...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func getInitialViewController() -> UIViewController {
        ...
        if isLoggedIn {
            ...
            navigationController.setViewControllers([loginController, channelsListController], animated: false)
    ...
    private func checkLoginStatus() -> Bool {
        ...
        if isLoggedIn {
            ...
            userDefaults.setValue(false, forKey: "isLoggedIn")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "DemoAssignment")
